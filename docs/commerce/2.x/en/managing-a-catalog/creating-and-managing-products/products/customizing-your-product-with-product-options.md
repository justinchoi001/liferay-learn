...
1. Go to the _Global_ menu → _Commerce_ → _Options_.
...
1. Go to the _Global_ menu → _Commerce_ → _Products_.
...
1. Click the _Values_ link next to _Color_.
1. Click the (![Add icon](../../../images/icon-add.png)) Add Option Values button.
1. Enter the following:
    * **Name:** Black
    * **Priority:** 1.0
    * **Key:** (autogenerated from the _Name_ field)

        ![Add values to the Product Option.](./customizing-your-product-with-product-options/images/02.png)
...
1. Click on any product listed there. For example, if the Minium accelerator was used to create the site, one sample product is the _Torque Converters_.
    ...
    ![Select a product](./customizing-your-product-with-product-options/images/03.png)

1. Click _Torque Converters_.
1. Click the _Options_ tab.

    ![Navigate to the Options tab.](./customizing-your-product-with-product-options/images/04.png)

1. Click the (![Add icon](../../../images/icon-add.png)) button to add an Option.
1. Check the box for _Package Quantity_.
1. Enter **1.0** in the _Priority_ field.

    ![Add an option.](./customizing-your-product-with-product-options/images/05.png)
